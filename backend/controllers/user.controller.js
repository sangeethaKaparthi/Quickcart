...
import uploadImageCloufonary from '../utils/uploadImageCloudinary.js';
...
export async function registerUserController(request, response) {
    try {
        ...
        console.log('User check completed, user exists:', !!user);
        ...
        console.log('User saved, ID:', save._id);
...
export async function loginController(request,response){
    try {
        ...
        const cookiesOption = {
              ...
              sameSite: isProduction ? "None" : "Lax" // "Lax" for local, "None" for cross-site
        };
...
export async function uploadAvatar(request,response){
    try {
        ...
        const upload = await uploadImageCloufonary(image)
