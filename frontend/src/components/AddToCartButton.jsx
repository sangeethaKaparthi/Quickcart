        ...
        <div className='w-full max-w-[150px]'>
            {
                isAvailableCart ? (
                    ...
                    <button onClick={handleADDTocart} className="border border-green-500 text-green-500 font-semibold px-4 py-1 rounded-md hover:bg-green-50 transition-colors">
                        {loading ? <Loading /> : "Add"}
                    </button>
                )
            }
